<p align="center">
   <img src="https://github.com/mattheussAL/neext-level-week--2/blob/master/.github/logo.png" alt="Proffy" width="280"/>
</p>

<p align="center">	
<a href="https://www.linkedin.com/in/matheus-alves-b5038a184/">
  <img alt="Matheus Alves" src="https://img.shields.io/badge/-Matheus Alves-8257E5?style=flat&logo=Linkedin&logoColor=white" />
  </a>
  <img alt="Repository size" src="https://img.shields.io/github/repo-size/mattheussAL/neext-level-week--2?color=774DD6">

  <a aria-label="Completed" href="https://nextlevelweek.com/episodios/omnistack/edicao/2">
    <img src="https://img.shields.io/badge/Proffy-NLW 2.0-8257E5?logo=data:image/png;base64,"></img>
  </a>
  <a href="https://github.com/mattheussAL/proffy/commits/master">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/mattheussAL/neext-level-week--2?color=774DD6">
  </a> 
  <img alt="License" src="https://img.shields.io/badge/license-MIT-8257E5">
   <a href="https://github.com/mattheussAL/proffy/stargazers">
    <img alt="Stargazers" src="https://img.shields.io/github/stars/mattheussAL/neext-level-week--2?color=8257E5&logo=github">
  </a>
</p>
...
<div style="display: flex; flex-direction: 'row'; align-items: 'center';">
   <img src="https://github.com/mattheussAL/neext-level-week--2/blob/master/.github/web-landing.png" width="400px">
   <img src="https://github.com/mattheussAL/neext-level-week--2/blob/master/.github/web-list.png" width="400px">
</div>

### Mobile Screenshot
<div style="display: flex; flex-direction: 'row';">
   <img src="https://github.com/mattheussAL/neext-level-week--2/blob/master/.github/mobile-splash.png" width="180">
   <img src="https://github.com/mattheussAL/neext-level-week--2/blob/master/.github/mobile-onboarding.png" width="180">
   <img src="https://github.com/mattheussAL/neext-level-week--2/blob/master/.github/mobile-home.png" width="180">
   <img src="https://github.com/mattheussAL/neext-level-week--2/blob/master/.github/mobile-favoritos.png" width="180">
</div>
...
```bash
# Clone Repository
$ git clone https://github.com/mattheusAL/Proffy_nlw.git
```
### 📦 Run API
...
Feel free to **file a new issue** with a respective title and description on the the [Proffy](https://github.com/mattheussAL/Proffy_nlw/issues) repository. If you already found a solution to your problem, **i would love to review your pull request**!

# :tada: Contributing

Check out the [contributing](https://github.com/mattheussAL/Proffy_nlw/blob/master/CONTRIBUTING.md) page to see the best places to file issues, start discussions and begin contributing.

# :closed_book: License

Released in 2020 :closed_book: License

Made with love by [Matheus Alves](https://github.com/mattheussAL) 🚀.
This project is under the [MIT license](https://github.com/mattheussAL/Proffy_nlw/master/LICENSE).
